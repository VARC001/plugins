...
from VXSTORM.core import ENV, LOGS, db
...
class TelegraphAPI:
    ...
    async def setup(self):
        ...
        try:
            ...
            LOGS.warning("ꜰᴀɪʟᴇᴅ ᴛᴏ ꜱᴇᴛᴜᴘ ᴛᴇʟᴇɢʀᴀᴘʜ ᴀᴘɪ")


class Gcast:
    def __init__(self) -> None:
        self.file_name = "gcast_{0}.txt"
        self.complete_msg = "**🍀ɢᴄᴀꜱᴛ ᴅᴏɴᴇ**"
